...
export function sessionExcerciseHtml(excerciseTotalCount) {
    return `
        <div class="flex flex-col session-excercise-row gap-4">
            <div class="pb-2">
                <label>Ejercicio</label>
                <div id="session-excercise-name-${excerciseTotalCount}"></div>                
            </div>
            <div class="grid grid-cols-[auto_auto_auto_auto_6rem] justify-stretch gap-4 items-center">            
                <div>
                    <label>Series</label>
                    <input class="session-excercise-steps input" type="text" id="session-excercise-steps-${excerciseTotalCount}" value="4" autocomplete="off">
                </div>

                <div>
                    <label>Repeticiones</label>
                    <input class="session-excercise-reps input" type="text" id="session-excercise-reps-${excerciseTotalCount}" value="8" autocomplete="off">
                </div>

                <div>
                    <label>Peso (kg)</label>
                    <input class="session-excercise-weight input" type="text" id="session-excercise-weight-${excerciseTotalCount}" value="0" autocomplete="off">
                </div>

                <div>
                    <label>Descanso (min)</label>
                    <input class="session-excercise-rest input" type="text" id="session-excercise-rest-${excerciseTotalCount}" value="1" autocomplete="off">
                </div>

                <div class="ml-6">
                    <label>&nbsp;</label>
                    <button class="delete-excercise button-small-cancel p-2" type="button"><span class="material-symbols-outlined">delete</span></button>
                </div>
            </div>
        </div>       
    `;
            ...
            <div class="plan-session-accordion" data-session-id="${sid}">
                <div class="grid grid-cols-3 gap-4 p-4">
                    <div class="col-span-2"> 
                        ...
                        <input type="text" class="input plan-session-name-input" maxlength="50" autocomplete="off">
                    </div>
                    <div>
                        <label>Orden</label>
                        <input type="number" class="input session-order" value="${sessionCount}" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="flex flex-row-reverse p-4">
                    <div><button class="delete-session-btn button-small-cancel mt-6 mb-3" type="button"><span class="material-symbols-outlined">delete</span>Eliminar Sesión</button></div>
                </div>
            </div>
        </div>
    `;
...
export function planPreviewHtml() {
    return `
        <div class="">
        ...
        <div class="plan-new-header flex gap-4 items-center pl-20 pr-20">
            ...
            <div>
                <div class="flex flex-row gap-4 items-center">
                    <button class="button-cancel" id="btn-cancel-plan">Cancelar</button>
                    <button class="button" id="btn-save-plan"><span class="material-symbols-outlined">save</span>Guardar Plan</button>
                </div>
            </div>
        </div>
        <div class="flex flex-row w-full">
            <div class="plan-new-main">
                <div id="plan-preview-container" class="pl-20 pt-6 pb-6 pr-10 space-y-6">
                    ${planPreviewHtml()}
                </div>
                <div class="plan-new-create pr-20 pt-6 pb-6 pl-10  space-y-6">
                    ...
                    <div class="plan-new-create-general">
                        ...
                        <div class="p-6 pt-0 space-y-4">
                            <div class="space-y-2">
                                ...
                                <input class="input" id="plan-name" placeholder="Ej: Fuerza Avanzada" maxlength="80" autocomplete="off">
                            </div>
                            <div class="space-y-2">
                    ...
                    <div class="plan-new-create-sessions">
                        ...
                        <div class="p-6 pt-0">
                            <div class="space-y-4">
                                <div id="plan-sessions-container" class="space-y-4"></div>
                            </div>
                        </div>
                    </div>
                </div>
